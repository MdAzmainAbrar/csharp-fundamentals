...
namespace Project12
{
    public class Person : Object// all classes in C# implicitly inherit from the Object class,
                                  // which is the base class for all types in C#.

    // inheritance refers to as an "is a" relationship
    // inheritance person  is a subclass of object 
